import fs from 'fs';
import type { ResponseLike } from 'merchant-categories/internal/to-file';
import { toFile } from 'merchant-categories/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('merchant-categories/core/uploads');
    await expect(
