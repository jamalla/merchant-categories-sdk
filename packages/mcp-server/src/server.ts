...
import { ClientOptions } from 'merchant-categories';
...
export { ClientOptions } from 'merchant-categories';
...
export function initMcpServer(params: {
  ...
  const client = new MerchantCategories(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new MerchantCategories({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
